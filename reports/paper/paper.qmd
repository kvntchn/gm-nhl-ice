...
**Authors:** Kevin T. Chen\^a, b\^, Sally Picciotto^c^, Ellen A.
Eisen^c^

^a^ University of California, Berkeley School of Public Health, Division
of Epidemiology & Biostatistics

^b^ University of California, Berkeley Department of Statistics

^c^ University of California, Berkeley School of Public Health, Division
...
**Running head suggestion:** Hypothetical interventions with guaranteed positivity
...
Grant T42OH008429 and Research Project Grant R01OH011092, both from
...
**Word count** **(Limit: 1500 to 4000 words):** 3842 (approx)
...
**Methods:** We defined hypothetical supportable interventions that
reduce annual daily average exposures above a specific target limit to
that limit when supported by data. When the target limit is not
supported, the intervention reduces exposure to the nearest supported
level of exposure. We estimated counterfactual risk of NHL between 1985
and 2015 in the UAW-GM cohort of autoworkers at three Michigan plants (n
...
mg/m^3^, the NIOSH recommended exposure limit, would have prevented 124
(95% CI: 66, 202) cases.

**Conclusion:** More stringent limits on exposure to soluble MWF provide
stronger protections against NHL. We expect that uniformly enforcing the
target exposure limits, regardless of data support, would have even
stronger protective effects. Strengthening exposure limits for MWF may
protect workers from NHL during the anticipated boom in domestic
manufacturing.
...
[@seer_1994; @Ekstrom-Smedby_2006]. The strongest known risk factor of
NHL is immunosuppression, both congenital and acquired
...
by the observed data, *i.e.,* those involving hypothetical interventions
with propensity score strictly greater than zero. Here, we defined
