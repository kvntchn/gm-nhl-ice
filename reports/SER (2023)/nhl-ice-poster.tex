        ...
        \begin{block}{Target and supportable exposure limits}
          ...
          \begin{figure}
            ...
            \begin{tikzpicture}[x=2.5pt,y=2.5pt]
              \input{resources/intervention-density.tex}
            \end{tikzpicture}
          \end{figure}
    ...
    \begin{column}{\onecolwid} % Begin a column which is two columns wide (column 2)
      \vbox to 0.78\paperheight{
        ...
        \begin{figure}
          ...
          \begin{tikzpicture}[x=2.5pt,y=2.5pt]
            \input{resources/intervention-density-witnin-combos.tex}
          \end{tikzpicture}
        \end{figure}
      ...
      \vbox to 0.78\paperheight{
        ...
        \begin{alertblock}{Main results}
          ...
          \begin{figure}
            ...
            \begin{tikzpicture}[x=2.5pt,y=2.5pt]
              \input{resources/rd.tex}
            \end{tikzpicture}
          \end{figure}

          \begin{itemize}
            \item There would have been \textbf{502 NHL cases} if there was no censoring
